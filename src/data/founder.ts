// "La historia" — the founder story. First-person, in Estefanía's own voice;
// this is the section that earns trust by being honest about origin (built
// from inside one real salon, not from an office looking in).
...
export const founder = {
  ...
  role: "Fundadora · Amorelila & AgendaLila",
  photo: "/photos/estefania-profile.jpg",
  alt: "Estefanía Sánchez, fundadora de Amorelila Estética y AgendaLila",
} as const;
